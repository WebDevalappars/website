...
io.on('connection',socket=>{
    ...
    socket.on('send-general',message=>{
        socket.broadcast.emit('recieve-general',{message:message,name:users[socket.id]})
    })
...
io.on('connection',socket=>{
    ...
    socket.on('send-sports',message=>{
        socket.broadcast.emit('recieve-sports',{message:message,name:sports[socket.id]})
    })
...
io.on('connection',socket=>{
    ...
    socket.on('send-drama',message=>{
        socket.broadcast.emit('recieve-drama',{message:message,name:drama[socket.id]})
    })
...
io.on('connection',socket=>{
    ...
    socket.on('send-web',message=>{
        socket.broadcast.emit('recieve-web',{message:message,name:webDev[socket.id]})
    })
...
io.on('connection',socket=>{
    ...
    socket.on('send-app',message=>{
        socket.broadcast.emit('recieve-app',{message:message,name:appDev[socket.id]})
    })
...
io.on('connection',socket=>{
    ...
    socket.on('send-cp',message=>{
        socket.broadcast.emit('recieve-cp',{message:message,name:cp[socket.id]})
    })
